...
class RegistryAgent:
    ...
    def register_birth(self, username):
        ...
        if (
            first_name.lower() == mother_fname.lower()
            and last_name.lower() == mother_lname.lower()
        ) or (
            ...
            mother_fname.lower() == father_fname.lower()
    ...
    def register_marriage(self, username):
        ...
        if p1_first_name.lower() == p2_first_name.lower and p1_last_name.lower() == p2_last_name.lower():
